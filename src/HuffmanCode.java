...
public class HuffmanCode {
    ...
    //codesMap hash map of each chracter as a key an its code as a value
    //  ex.{a:010,b:1,c:011}
    //header string ex.{"a`,010`,b`,1`,c`,011`,`,"}
    ...
    //converts the codes map to header string,header string ex.{"a`,010`,b`,1`,c`,011`,`,"}
    // hash map of each chracter as a key an its code as a value
    //  ex.{a:010,b:1,c:011}
    ...
    //create codes map from huffman tree by traversing it to find each character code
    // characterSet    set of characters to find thier codes
    //huffmanTreeRoot the root node of huffman tree
    //hash map of each chracter as a key an its code as a value
    //  ex.{a:010,b:1,c:011}
    ...
    //huffmanTree intial list of huffman tree nodes. each node's data =
    //ex.{AsciiElement({'a',11})}, and it's left and right childs will be null
    ...
    //header a string that will be converted to codes map,data comperessed string original string
